...
/ rectangle.c
/
/ A program in C to calculate the area under a curve by using the Rectangle
/ Rule (midpoint rule).  This is also called the 2nd Degree Open Newton-Cotes
/ Formula.
/
/ Paul Soper
/
